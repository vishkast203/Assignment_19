...
candidate_database = {
    ...
    "Ash": ["Ash", "0x2422858F9C4480c2724A309D58Ffd7Ac8bF65396", "5.0", .02, "Images/ash.jpeg"],
    "Jo": ["Jo", "0x8fD00f170FDf3772C5ebdCD90bF257316c69BA45", "4.7", .19, "Images/jo.jpeg"],
    "Kendall": ["Kendall", "0x8fD00f170FDf3772C5ebdCD90bF257316c69BA45", "4.1", .02, "Images/kendall.jpeg"]
}
...
eth_amount = get_balance(account.address) 
st.sidebar.write(eth_amount)
##########################################
...
total_wage = candidate_database[person][3] * hours 
...
if st.sidebar.button("Send Transaction"):
    ...
    transaction_hash = send_transaction(account, candidate_address, total_wage)
